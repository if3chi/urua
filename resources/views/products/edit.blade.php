    ...
    <div class="row">
        <form action="{{ route('products.update', $product->id) }}" method="POST" class="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="textarea" class="form-control border-info @error('description') border-danger @enderror" placeholder="Product Description" name="description" value="{{ $product->description }}">
            </div>
            <div class="form-group">
